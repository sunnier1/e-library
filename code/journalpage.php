...
<?php include 'top-bar.php'; ?>
    ...
    <div class="btn1">
        ...
        <div class="btn2">
            <button class="book-pg" onclick="window.location.href = 'bookpage.php';"> Book</button>
            <button class="journal-pg" style="background-color: #553991;"> Journal</button>
        </div>       
    </div>       
    ...
    $query = "SELECT * FROM books where upload_type ='journal' ";
